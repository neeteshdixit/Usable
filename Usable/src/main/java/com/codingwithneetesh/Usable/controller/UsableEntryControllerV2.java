...
import com.codingwithneetesh.Usable.service.UsableEntryService;
...
public class UsableEntryControllerV2 {

    @Autowired
    private UsableEntryService usableEntryService;
    @GetMapping("/abc")
    ...
    public boolean createEntry(@RequestBody UsableEntry myEntry) { //localhost:8080/usable POST
        usableEntryService.saveEntry(myEntry);
        return true;
    }
